<script>
    function getData( event_id ){
        status = "working";
        var ret = $.ajax({
            url : '../timingDetails/ajax?a=pushFinishData&event_id='+event_id,
            dataType: 'json',
            beforeSend: function(){
     ...
     function setData( event_id ){
        status = "working";
        var ret = $.ajax({
            url : '../timingDetails/ajax?a=saveFinishData&event_id='+event_id,
            type: 'POST',
...
?>
<input type='button' value='Stop a rider' onclick='postTheTime()' id='stopButton' />
